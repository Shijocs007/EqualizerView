...
public class Equalizer extends LinearLayout {
    ...
    public Equalizer(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void getAttrs(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.Equalizer, 0, 0);

        try {

            mRunInBatterySafeMode = a.getBoolean(R.styleable.Equalizer_runInBatterySaveMode, DEFAULT_RUN_IN_BATTERY_SAVE_MODE);
            mForegroundColor = a.getInt(R.styleable.Equalizer_barColor, DEFAULT_COLOR);
            mAnimationDuration = a.getInt(R.styleable.Equalizer_animationDuration, DEFAULT_DURATION);
            mBarCount = a.getInt(R.styleable.Equalizer_barCount, DEFAULT_BAR_COUNT);
            mBarWidth = (int) a.getDimension(R.styleable.Equalizer_barWidth, DEFAULT_WIDTH);
            mMarginLeft = (int) a.getDimension(R.styleable.Equalizer_marginLeft, DEFAULT_MARGIN_LEFT);
            mMarginRight = (int) a.getDimension(R.styleable.Equalizer_marginRight, DEFAULT_MARGIN_RIGHT);
